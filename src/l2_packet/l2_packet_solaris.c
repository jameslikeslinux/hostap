...
/* ARGSUSED */
struct l2_packet_data *
l2_packet_init(const char *ifname, const uint8_t *own_addr, unsigned short protocol,
	void (*rx_callback)(void *, const unsigned char *, const unsigned char *, size_t),
	void *rx_callback_ctx, int l2_hdr)  /* TODO: Check l2_hdr value */
{
	int retval;
